 ...
 */
export interface OnChatMessageSentResponseMediaDTO {
  media_id: string;
  filename: string;
  mime_type: string;
...
/**
 * @name OnChatMessageSentResponseSenderDTO
 *
 ...
 */
export interface OnChatMessageSentResponseSenderDTO {
  id: string;
  is_bot: boolean;
  name: string;
}
...
/**
 * @name OnChatMessageSentResponseDTO
 *
 ...
 */
export interface OnChatMessageSentResponseDTO {
  message_id: string;
  contact_id: string;
  contacts: null;
