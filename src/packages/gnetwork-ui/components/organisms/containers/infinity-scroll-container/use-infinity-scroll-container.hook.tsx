...
/**
 * @name UseInfinityScrollContainerOptions
 *
 ...
 */
export interface UseInfinityScrollContainerOptions {
...
/**
 * @name useInfinityScrollContainer
 *
 ...
 */
export const useInfinityScrollContainer = (
  props: UseInfinityScrollContainerOptions = {},
) => {
  const {
