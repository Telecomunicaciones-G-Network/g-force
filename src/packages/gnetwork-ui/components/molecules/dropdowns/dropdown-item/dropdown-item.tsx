...
export const DropdownItem = ({
  ...
  return (
    <DropdownMenuPrimitive.Item
      className={cn(
        styles.base,
        'cursor-pointer flex font-normal gap-2 items-center p-2 rounded-lg text-neutral-500 text-xs transition-colors focus:bg-neutral-600 focus:text-chromatic focus:font-bold hover:bg-neutral-600 hover:text-chromatic data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:[&_svg]:fill-chromatic focus:[&_svg]:fill-chromatic hover:**:text-chromatic! focus:**:text-chromatic!',
        inset && 'pl-2',
        className,
      )}
      onClick={onClick}
