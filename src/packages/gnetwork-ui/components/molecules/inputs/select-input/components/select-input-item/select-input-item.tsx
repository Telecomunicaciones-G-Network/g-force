...
export const SelectInputItem = ({
  ...
  <SelectPrimitive.Item
    className={cn(
      styles.base,
      'py-2 px-2 pl-8 rounded-sm text-sm transition-colors hover:bg-neutral-100 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[disabled]:cursor-not-allowed',
      className,
    )}
    ref={ref}
    {...rest}
