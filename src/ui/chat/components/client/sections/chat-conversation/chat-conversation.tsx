...
// TODO: Debo fragmentar este componente en trozos mas pequeños y reutilizables
// TODO: Debo ver como sera el manejo de las fechas o horas en los mensajes
          ...
          >
            <Avatar
              customBackgroundColor={
                activeContact?.id && `#${activeContact?.id?.slice(0, 6)}`
              }
