...
import type { OnChatConversationFinishedResponseDTO } from '@module-chat/infrastructure/dtos';

import { onSocketEvent } from '@socketio/hooks/use-socket-event.hook';

import { socketEventsDictionary } from '@module-chat/infrastructure/dictionaries/socket-events.dictionary';

import { OnChatConversationFinishedMapper } from '@module-chat/infrastructure/mappers/on-chat-conversation-finished.mapper';
...
/**
 * @name useOnChatConversationFinished
 *
 ...
 * @returns void
 */
export const useOnChatConversationFinished = () => {
  ...
  onSocketEvent<OnChatConversationFinishedResponseDTO>(
    socketEventsDictionary.CHAT_CONVERSATION_FINISHED,
    (data: OnChatConversationFinishedResponseDTO) => {
      ...
      const response = OnChatConversationFinishedMapper.mapFrom(parseResponse);
